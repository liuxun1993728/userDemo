...
import com.anrong.user.core.config.Global;
import com.anrong.user.core.utils.FileUploadUtils;
...
public class FileUploadController {
	...
	private String imageDirectory = "c:/imgs/";
	...
	private String uploadAndGetPath(MultipartFile file) {
		...
		return new File(rd, uuidname).getPath().substring(imageDirectory.length() - 1);
	}
